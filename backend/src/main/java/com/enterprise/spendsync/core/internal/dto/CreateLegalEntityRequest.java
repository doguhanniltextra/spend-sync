...
public record CreateLegalEntityRequest(
        ...
        @Pattern(regexp = "^[A-Z]{3}$", message = "Base currency must be ISO 4217 (e.g. TRY, EUR, USD)")
        String baseCurrency,
        ...
        @Pattern(regexp = "^[A-Z]{2}$", message = "Country code must be ISO 3166-1 alpha-2 (e.g. TR, NL, DE)")
        String country
) {}
