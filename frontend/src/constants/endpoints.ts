...
export const ENDPOINTS = {
  ...
  purchasing: {
    ...
    inviteVendor:             '/purchasing/vendors/invite',
    bankChangeRequests:       '/purchasing/vendors/bank-change-requests',
    approveBankChange: (id: string) => `/purchasing/vendors/bank-change-requests/${id}/approve`,
    rejectBankChange: (id: string)  => `/purchasing/vendors/bank-change-requests/${id}/reject`,
  ...
  vendorPortal: {
    acceptInvite:             '/vendor-portal/auth/accept-invite',
    login:                    '/vendor-portal/auth/login',
    profile:                  '/vendor-portal/profile',
    bankChangeRequest:        '/vendor-portal/profile/bank-change-request',
    orders:                   '/vendor-portal/orders',
    orderById: (id: string)   => `/vendor-portal/orders/${id}`,
    acknowledgeOrder: (id: string) => `/vendor-portal/orders/${id}/acknowledge`,
    dispatchAsn: (id: string) => `/vendor-portal/orders/${id}/dispatch`,
    invoices:                 '/vendor-portal/invoices',
    invoiceById: (id: string) => `/vendor-portal/invoices/${id}`,
    poFlipInvoice: (poId: string) => `/vendor-portal/invoices/po-flip/${poId}`,
    ublUpload:                '/vendor-portal/invoices/ubl-upload',
    invoiceHtml: (id: string) => `/vendor-portal/invoices/${id}/html`,
    paymentStatus: (id: string) => `/vendor-portal/invoices/${id}/payment-status`,
    acceptEarlyDiscount: (id: string) => `/vendor-portal/invoices/${id}/accept-early-discount`,
    proposeCatalogItem:       '/vendor-portal/catalog/propose',
    statementOfAccounts:      '/vendor-portal/finance/statement-of-accounts',
    reconciliationSummary:    '/vendor-portal/finance/reconciliation/summary',
    approveReconciliation:    '/vendor-portal/finance/reconciliation/approve',
  },
} as const
